...
function Dashboard() {
    ...
    const [syncBanks, { isLoading: syncLoading }] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2f$api$2f$AuthApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncBanksMutation"])();
    ...
    const [getAccountTransactions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2f$api$2f$AuthApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLazyGetAccountTransactionsQuery"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            const loadTransactions = {
                "Dashboard.useEffect.loadTransactions": async ()=>{
                    if (!accountsData?.banks || accountsData.banks.length === 0) {
                    ...
                    try {
                        ...
                        const promises = accountsData.banks.flatMap({
                            "Dashboard.useEffect.loadTransactions.promises": (bank)=>bank.accounts.map({
                                    "Dashboard.useEffect.loadTransactions.promises": async (account)=>{
                                        try {
                                            ...
                                            if (result?.data?.transaction && Array.isArray(result.data.transaction)) {
                                                return result.data.transaction.map({
                                                    "Dashboard.useEffect.loadTransactions.promises": (tx)=>({
                                                            ...tx,
                                                            accountName: account.nickname || account.accountName,
                                                            bankId: bank.bankId
                                                        })
                                                }["Dashboard.useEffect.loadTransactions.promises"]);
                                            }
                                            return [];
                                        } catch (error) {
                        ...
                        flatTransactions.sort({
                            "Dashboard.useEffect.loadTransactions": (a, b)=>{
                        ...
                        }["Dashboard.useEffect.loadTransactions"]);
                                                            ...
                                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            incomeHeight > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                style: {
                                                                                    width: '100%',
                                                                            ...
                                                                            expenseHeight > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                style: {
                                                                                    width: '100%',
...
_s(Dashboard, "JUMcClxsIzJ9AzRL/q2eg1PLfu4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2f$api$2f$UserApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetCurrentUserQuery"],
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2f$api$2f$AuthApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLazyGetAccountTransactionsQuery"],
...
//# sourceMappingURL=src_12bbb16a._.js.map