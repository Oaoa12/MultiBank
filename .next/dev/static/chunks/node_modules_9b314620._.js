...
function useTimeout(callback, delay, options = {
    ...
    const start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTimeout.useCallback[start]": (...args)=>{
...
"[project]/node_modules/@mantine/hooks/esm/use-radial-move/use-radial-move.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function normalizeRadialValue(degree, step) {
    const clamped = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$utils$2f$clamp$2f$clamp$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clamp"])(degree, 0, 360);
...
function useRadialMove(onChange, { step = 0.01, onChangeEnd, onScrubStart, onScrubEnd } = {}) {
    ...
    const refCallback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useRadialMove.useCallback[refCallback]": (node)=>{
            const update = {
                "useRadialMove.useCallback[refCallback].update": (event, done = false)=>{
                    if (node) {
            ...
            }["useRadialMove.useCallback[refCallback].update"];
            const beginTracking = {
                "useRadialMove.useCallback[refCallback].beginTracking": ()=>{
                    onScrubStart?.();
                    setActive(true);
            ...
            const endTracking = {
                "useRadialMove.useCallback[refCallback].endTracking": ()=>{
                    onScrubEnd?.();
                    setActive(false);
            ...
            const onMouseDown = {
                "useRadialMove.useCallback[refCallback].onMouseDown": (event)=>{
                    beginTracking();
                    update(event);
                }
            }["useRadialMove.useCallback[refCallback].onMouseDown"];
            const handleMouseMove = {
                "useRadialMove.useCallback[refCallback].handleMouseMove": (event)=>{
                    update(event);
                }
            }["useRadialMove.useCallback[refCallback].handleMouseMove"];
            const handleMouseUp = {
                "useRadialMove.useCallback[refCallback].handleMouseUp": (event)=>{
                    update(event, true);
                    endTracking();
                }
            }["useRadialMove.useCallback[refCallback].handleMouseUp"];
            const handleTouchMove = {
                "useRadialMove.useCallback[refCallback].handleTouchMove": (event)=>{
                    event.preventDefault();
                    update(event.touches[0]);
                }
            }["useRadialMove.useCallback[refCallback].handleTouchMove"];
            const handleTouchEnd = {
                "useRadialMove.useCallback[refCallback].handleTouchEnd": (event)=>{
                    update(event.changedTouches[0], true);
                    endTracking();
                }
            }["useRadialMove.useCallback[refCallback].handleTouchEnd"];
            const handleTouchStart = {
                "useRadialMove.useCallback[refCallback].handleTouchStart": (event)=>{
                    event.preventDefault();
                    beginTracking();
                    update(event.touches[0]);
                }
            }["useRadialMove.useCallback[refCallback].handleTouchStart"];
            node?.addEventListener("mousedown", onMouseDown);
            node?.addEventListener("touchstart", handleTouchStart, {
                passive: false
            });
            return ({
                "useRadialMove.useCallback[refCallback]": ()=>{
                    if (node) {
...
function useMove(onChange, handlers, dir = "ltr") {
    ...
    const refCallback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMove.useCallback[refCallback]": (node)=>{
            ...
            const onScrub = {
                "useMove.useCallback[refCallback].onScrub": ({ x, y })=>{
                    cancelAnimationFrame(frame.current);
                    frame.current = requestAnimationFrame({
                        "useMove.useCallback[refCallback].onScrub": ()=>{
            ...
            const bindEvents = {
                "useMove.useCallback[refCallback].bindEvents": ()=>{
            ...
            const unbindEvents = {
                "useMove.useCallback[refCallback].unbindEvents": ()=>{
            ...
            const startScrubbing = {
                "useMove.useCallback[refCallback].startScrubbing": ()=>{
            ...
            const stopScrubbing = {
                "useMove.useCallback[refCallback].stopScrubbing": ()=>{
                    if (isSliding.current && mounted.current) {
                        ...
                        }["useMove.useCallback[refCallback].stopScrubbing"], 0);
                    }
                }
            }["useMove.useCallback[refCallback].stopScrubbing"];
            const onMouseDown = {
                "useMove.useCallback[refCallback].onMouseDown": (event)=>{
                    startScrubbing();
                    event.preventDefault();
                    onMouseMove(event);
                }
            }["useMove.useCallback[refCallback].onMouseDown"];
            const onMouseMove = {
                "useMove.useCallback[refCallback].onMouseMove": (event)=>onScrub({
                        x: event.clientX,
                        y: event.clientY
                    })
            }["useMove.useCallback[refCallback].onMouseMove"];
            const onTouchStart = {
                "useMove.useCallback[refCallback].onTouchStart": (event)=>{
                    if (event.cancelable) {
                        event.preventDefault();
                    }
                    startScrubbing();
            ...
            }["useMove.useCallback[refCallback].onTouchStart"];
            const onTouchMove = {
                "useMove.useCallback[refCallback].onTouchMove": (event)=>{
                    if (event.cancelable) {
                        event.preventDefault();
                    }
                    onScrub({
            ...
            }["useMove.useCallback[refCallback].onTouchMove"];
            node.addEventListener("mousedown", onMouseDown);
            node.addEventListener("touchstart", onTouchStart, {
                passive: false
            });
            cleanupRef.current = ({
                "useMove.useCallback[refCallback]": ()=>{
                    node.removeEventListener("mousedown", onMouseDown);
...
"[project]/node_modules/@mantine/hooks/esm/use-eye-dropper/use-eye-dropper.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useEyeDropper() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$use$2d$isomorphic$2d$effect$2f$use$2d$isomorphic$2d$effect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIsomorphicEffect"])({
        "useEyeDropper.useIsomorphicEffect": ()=>{
    ...
    const open = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useEyeDropper.useCallback[open]": (options = {})=>{
            if (supported) {
    ...
    }["useEyeDropper.useCallback[open]"], [
        supported
    ]);
    return {
        supported,
...
"[project]/node_modules/@mantine/hooks/esm/use-clipboard/use-clipboard.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@mantine/hooks/esm/use-mounted/use-mounted.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@mantine/hooks/esm/utils/shallow-equal/shallow-equal.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@mantine/hooks/esm/use-shallow-effect/use-shallow-effect.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$utils$2f$shallow$2d$equal$2f$shallow$2d$equal$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mantine/hooks/esm/utils/shallow-equal/shallow-equal.mjs [app-client] (ecmascript)");
'use client';
;
;
function shallowCompare(prevValue, currValue) {
    ...
    for(let i = 0; i < prevValue.length; i += 1){
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$utils$2f$shallow$2d$equal$2f$shallow$2d$equal$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shallowEqual"])(prevValue[i], currValue[i])) {
            return false;
        }
    }
    return true;
...
function useShallowEffect(cb, dependencies) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(cb, useShallowCompare(dependencies));
}
;
...
"[project]/node_modules/@mantine/hooks/esm/use-resize-observer/use-resize-observer.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useResizeObserver(options) {
    const frameID = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [rect, setRect] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultState);
...
"[project]/node_modules/@mantine/hooks/esm/use-scroll-spy/use-scroll-spy.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getHeadingsData(headings, getDepth, getValue) {
    ...
    for(let i = 0; i < headings.length; i += 1){
        ...
        result.push({
            ...
            id: heading.id || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$utils$2f$random$2d$id$2f$random$2d$id$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randomId"])(),
...
function useScrollSpy({ selector = "h1, h2, h3, h4, h5, h6", getDepth = getDefaultDepth, getValue = getDefaultValue, offset = 0, scrollHost } = {}) {
    ...
    const headingsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    const handleScroll = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useScrollSpy.useEffect": ()=>{
            ...
            return ({
                "useScrollSpy.useEffect": ()=>_scrollHost.removeEventListener("scroll", handleScroll)
            })["useScrollSpy.useEffect"];
        }
    }["useScrollSpy.useEffect"], [
        scrollHost
...
//# sourceMappingURL=node_modules_9b314620._.js.map